...
const { doEasterEggHuntEvent } = require("./easterEggHunt");
const { doEasterEvilBunnyHunt } = require("./easterEvilBunnyHunt");
...
const easterEvent = (client, server) => {
  ...
  console.log('Easter event is waiting ' + msUntilNextStartOrEnd + ' milliseconds before calling again')
