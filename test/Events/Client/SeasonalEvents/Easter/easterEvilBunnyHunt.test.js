...
} = require('../../../../../src/SeasonalEvents/EvilEasterBunny/Pages/getEasterHuntEventOutcomePage');
jest.mock(
  '../../../../../src/SeasonalEvents/EvilEasterBunny/Pages/getEasterHuntEventOutcomePage'
);
...
} = require('../../../../../src/Events/Client/SeasonalEvents/Easter/EasterEvilBunny/easterEvilBunnyHunt');
const {
  defaultEasterHuntData,
} = require('../../../../../src/Schemas/easterHuntSchema');
const MockDiscord = require('../../../../utils/mockDiscord');

describe('easterEvilBunnyHunt', () => {
  let MOCKED_DISCORD;
  beforeEach(() => {
    // CLONED_MOCK_DATA = _.cloneDeep(INITIAL_MOCK_DATA);
    // MOCKED_DISCORD = new MockDiscord();
  });
  afterEach(() => {
    jest.resetAllMocks();
  });
  describe('noParticipantsEventStart', () => {
    ...
    test('should update the Guild document and send a message to the event channel', async () => {
      ...
      getEasterHuntEventOutcomePage.mockResolvedValue({
        embeddedMessage: expectedEmbeds,
      });
  ...
  describe('getActiveEventServers', () => {
    ...
    beforeEach(() => {
      mockActiveEventServers = [
        { guildId: '123', easterHunt: { eventState: 'inProgress' } },
        { guildId: '456', easterHunt: { eventState: 'preEvent' } },
      ];
      mockGuilds = [
        { id: '123', name: 'Guild 1' },
        { id: '789', name: 'Guild 2' },
  ...
  //     const mockGuildId = '12345';
  //     const mockGuildProfileId = '60b5b5b5b5b5b5b5b5b5b5b5'; // a valid ObjectId string
  ...
  //     expect(updatedGuildProfile.easterHunt).toEqual(
  //       expect.objectContaining({ isEventOver: false })
  //     );
  //   });
  ...
  //     expect(updatedGuildProfile.easterHunt.eventStartTime).toEqual(
  //       expect.any(Date)
  //     );
  //     expect(updatedGuildProfile.easterHunt.eventEndTime).toEqual(
  //       expect.any(Date)
  //     );
  //   });
  ...
  //     jest
  //       .spyOn(eventUtils, 'handleInProgress')
  //       .mockImplementation(handleInProgressMock);
